import { UserIcon, CodeIcon, DatabaseIcon, ServerIcon } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
          ...
          <div className="md:col-span-2">
            <p className="text-lg text-muted-foreground mb-6">
              Hi, I&apos;m Raghavendra Hande, a dedicated Full Stack Developer with a knack for solving complex problems and building elegant web applications. My journey in tech has been driven by a curiosity to learn and a passion for creating impactful digital solutions.
            </p>
            <p className="text-lg text-muted-foreground mb-6">
              I thrive in collaborative environments and enjoy working on projects from concept to deployment. With a strong foundation in both front-end and back-end technologies, I aim to deliver seamless user experiences and robust server-side logic.
            </p>
            <p className="text-lg text-muted-foreground">
              When I&apos;m not coding, I enjoy exploring new technologies, contributing to open-source projects, and [mention a hobby here, e.g., reading tech blogs, hiking].
            </p>
          </div>
        </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <SkillCategory title="Frontend" icon={<CodeIcon className="h-6 w-6 text-primary mb-2"/>} skills={skills.frontend} />
